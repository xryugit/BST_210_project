...
$$
\log\left(\frac{p_{sleep~disorder}}{1-p_{sleep~disorder}}\right) = \beta_{k,0} + \beta_{k,1} depression_{i} + \beta_{k,2} BMI _{i} + \beta_{k,3} alcohol_{i} + \beta_{k,4} Race_{i} + \beta_{k,5} age_{i} + \beta_{k,6} age^2_{i}+ \beta_{k,7} income_{i}
$$
...
The odds of ever having sleep trouble is estimated to be exp(0.1434) = 1.1542 times the odds of ever having sleep trouble among poeple with a one-unit higher depression score on average, holding other covariates constant, according to these sample data. 
