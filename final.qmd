...
$$
\log\left(\frac{p_{sleep~disorder}}{1-p_{sleep~disorder}}\right) = \beta_{0} + \beta_{1} depression_{i}
$$
...
$$
\log\left(\frac{p_{sleep~disorder}}{1-p_{sleep~disorder}}\right) = \beta_{0} + \beta_{1} depression_{i} + \beta_{2} BMI _{i} + \beta_{3} alcohol_{i} + \beta_{4} ethnicity_{i} + \beta_{5} age_{i} + \beta_{6} age^2_{i}+ \beta_{7} income_{i} + \beta_{8} \text{avg_MAP}_{i}
$$
